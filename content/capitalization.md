...
- Use sentence-style capitalization most of the time. That means:
	...
	- Capitalize proper nouns. To learn more about proper nouns, see [Nouns and pronouns](grammar/nouns-pronouns).
...
- For information on capitalization in hyphenated compound words see [Hyphens](punctuation/dashes-hyphens/hyphens).
...
For information about capitalizing UI labels in instructions, see [Formatting text in instructions](procedures-instructions/formatting-text-in-instructions).
...
**See also** [Formatting titles](text-formatting/formatting-titles)
