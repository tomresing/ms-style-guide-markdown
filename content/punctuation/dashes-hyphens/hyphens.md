...
- *Very,* when it precedes another modifier.
	**Example**  
	Very fast test
- An adverb ending in *\-ly,* such as *completely,* when it precedes another modifier. Check [Merriam-Webster Dictionary](https://merriam-webster.com/) if you're not sure whether the word ending in *\-ly* is an adverb.
	**Examples**  
