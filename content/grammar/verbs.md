...
| **Voice** | **Uses** | **Examples** |
| --- | --- | --- |
| **Active** | Most Microsoft content | Divide your document into as many sections as you want.   Office 365 includes the Office 2016 apps for PC and Mac. |
| **Passive** | - Avoiding condescending text or blaming the customer, especially in errors, warnings, or notifications - Avoiding awkward constructions - Emphasizing the receiver of the action | That site can’t be found. Double-check the site address in the Address bar.   When the user clicks **OK**, the transaction is committed. (in content for developers) |
...
| A singular thing and a plural thing connected by *or* | Singular or plural, to match the closest subject | Skype or social media apps are available from Microsoft Store.   Social media apps or Skype is available from Microsoft Store. |
