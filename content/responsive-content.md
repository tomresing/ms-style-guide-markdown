...
**Try to keep headings to one, short line.** Two-line headings take up twice as much scarce vertical space. Use short words in headings, too, if you can. If a customer uses larger fonts to improve accessibility, long words might break across lines.
...
**Keep in mind that the width of your customer's screen** might be just a couple of inches. Keep content simple so it's easy to read and understand.

**Choose simple images, and crop extraneous detail.**

**Add alt text to all images that convey important meaning,** to make them accessible. Images that are purely decorative don't need alt text. Learn more in [Alternative text (alt text)](/en-us/style-guide/accessibility/alternative-text).
...
**Simplify charts and graphs** so that readers can easily read the whole thing on a small screen. Craft very short chart titles, metrics labels, and axis labels.
