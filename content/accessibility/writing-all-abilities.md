...
**Spell out words like** ***and, plus,*****and** ***about.*** Screen readers can misread or skip text that uses special characters like the plus sign (+) and tilde (~).  See [special characters](../a-z-word-list-term-collections/term-collections/special-characters) for more detailed information.
...
**Learn more**  
[Describing alternative input methods](../procedures-instructions/describing-alternative-input-methods)
